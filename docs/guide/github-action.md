...
`@v1` floats to the latest `1.x` release; pin to a specific version or a SHA for reproducible runs. The action honors your [`.inuprc`](configuration.md) (`ignore`, `exclude`, `scanDirs`).
